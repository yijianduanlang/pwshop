...
INSERT INTO `addresses` VALUES (4, 11, '实时', '1566666', '北京市 市辖区 东城区', '滚滚滚', 1, 2, 3, 1, '2023-07-03 20:29:52', '2023-07-03 20:30:04', NULL);
...
INSERT INTO `admin_to_roles` VALUES (5, 2, 1, NULL, NULL, NULL);
...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES (1, 0, 'admin', '$2y$10$hK33S6rakhABix382ecAie9tP/LFgEz1xfYIITfTGeDE5H4ObMHZC', '超级管理员', '/storage/avatar/2021-11-29/3iRdmBH4otVN8AEX33CrDcxTpmKcf6cfNjMKIyAr.png', 1, '0.0.0.0', '2023-07-03 17:03:21', '2023-07-03 17:03:21', '2021-11-05 03:12:56', '2023-07-03 17:03:21', NULL);
INSERT INTO `admins` VALUES (2, 1, '666', '$2y$10$DQb/b.2AMU5Qv0PndvX8Q.KX7pPAAF01o4iygLIl34QHuX6E7PxZW', '666', '', 0, '0.0.0.0', NULL, NULL, '2023-07-03 17:05:52', '2023-07-03 17:05:52', NULL);
...
CREATE TABLE `advs`  (
  ...
  `adv_start` timestamp NOT NULL DEFAULT '2023-07-03 16:55:47' COMMENT '开始时间',
  `adv_end` timestamp NOT NULL DEFAULT '2023-07-04 16:55:47' COMMENT '结束时间',
...
CREATE TABLE `app_versions`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '名称' COMMENT '标题',
  `version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1.0.0' COMMENT '版本名称',
  `version_code` int(10) UNSIGNED NOT NULL DEFAULT 100 COMMENT '版本号',
  `url` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '上传地址',
  `device` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'android' COMMENT '设备类型',
  `apple_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '苹果ID',
  `is_wgt` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否资源包',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '更新内容',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `articles` VALUES (5, 1, 3, '帮助中心', '<p><span>sad</span></p>##qingwuit##[{\"type\":\"paragraph\",\"children\":[{\"text\":\"sad\"}]}]', 23, '2022-01-11 13:32:27', '2023-07-03 17:18:16', NULL);
...
CREATE TABLE `captchas`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `username` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '账户',
  `password` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '密码',
  `sign` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '签名',
  `step` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '步码',
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0.0.0.0' COMMENT '登陆IP',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
-- Records of captchas
-- ----------------------------
INSERT INTO `captchas` VALUES (1, 'admin', 'admin', '$2y$10$Fq76/8NZVqaXp4AaEuxkHu/15u7brfSQJ328Juh.5JDDC3t.xzX8W', 0, '127.0.0.1', '2023-07-03 17:03:20', '2023-07-03 17:03:20', NULL);
...
CREATE TABLE `chat_contents`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `sid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '发送者ID',
  `rid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '接收者ID',
  `stype` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Anonymous' COMMENT '发送者类型',
  `rtype` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Anonymous' COMMENT '接收者类型',
  `content_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text' COMMENT '内容类型',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '详情',
  `s_read` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '发送者查看',
  `r_read` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '接收者查看',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `chat_contents` VALUES (1, '11', '6', 'users', 'users', 'text', '45456', 1, 0, '2023-07-03 20:30:57', '2023-07-03 20:30:57', NULL);
INSERT INTO `chat_contents` VALUES (2, '6', '11', 'users', 'users', 'text', '555', 1, 0, '2023-07-03 20:31:16', '2023-07-03 20:31:16', NULL);
INSERT INTO `chat_contents` VALUES (3, '11', '6', 'users', 'users', 'text', '6', 1, 0, '2023-07-03 20:31:32', '2023-07-03 20:31:32', NULL);
INSERT INTO `chat_contents` VALUES (4, '11', '6', 'users', 'users', 'text', '', 1, 0, '2023-07-03 20:31:33', '2023-07-03 20:31:33', NULL);
...
-- ----------------------------
INSERT INTO `chat_friends` VALUES (1, '11', '6', 'users', 'users', '2023-07-03 20:30:51', '2023-07-03 20:31:33', NULL);
...
INSERT INTO `collective_logs` VALUES (4, 1, 6, 1, 17, 50.00, 2, 2, '2023-07-03 17:24:20', '2023-07-03 17:24:20', NULL);
INSERT INTO `collective_logs` VALUES (5, 1, 11, 1, 17, 50.00, 2, 2, '2023-07-03 20:30:30', '2023-07-03 20:30:30', NULL);
...
-- ----------------------------
INSERT INTO `collectives` VALUES (1, 1, 17, 50.00, 2, '2022-01-03 20:49:08', '2023-07-03 17:24:06', NULL);
...
INSERT INTO `configs` VALUES (15, 'pay', '{\"wechatwap\":{\"app_id\":\"asd\",\"mach_id\":\"asd\",\"mch_secret_key\":\"asd\",\"mch_secret_cert\":\"\\/crt\\/2022-01-12\\/ecxGbUEqcBneDzh0k0b3Szkk57fwNYiwvbigHsQV.png\",\"mch_public_cert_path\":\"\\/crt\\/2022-01-12\\/sd4Y6cH63hgLfUtmla4MvafPK6dqmQlM7YnrBtgT.png\",\"notify_url\":\"\\/api\\/payment\\/wechat\\/wap\"},\"wechatscan\":{\"mp_app_id\":\"111\",\"mch_id\":\"11\",\"mch_secret_key\":\"11\",\"notify_url\":\"\\/api\\/payment\\/wechat\\/scan\"},\"wechatmp\":{\"notify_url\":\"\\/api\\/payment\\/wechat\\/mp\"},\"wechatmini\":{\"notify_url\":\"\\/api\\/payment\\/wechat\\/mini\"},\"wechatapp\":{\"notify_url\":\"\\/api\\/payment\\/wechat\\/app\"},\"alipaywap\":{\"notify_url\":\"\\/api\\/payment\\/alipay\\/wap\"},\"alipayapp\":{\"notify_url\":\"\\/api\\/payment\\/alipay\\/app\"},\"alipaymini\":{\"notify_url\":\"api\\/payment\\/alipay\\/mini\"},\"alipayscan\":{\"notify_url\":\"\\/api\\/payment\\/alipay\\/scan\"}}', '支付配置', 1, NULL, '2023-07-03 20:38:10', NULL);
...
INSERT INTO `configs` VALUES (18, 'task', '{\"cancel\":\"1\",\"confirm\":\"4\",\"settlement\":\"7\"}', '定时任务', 1, NULL, '2023-07-03 17:06:41', NULL);
...
CREATE TABLE `coupon_logs`  (
  ...
  `money` decimal(9, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '优惠券金额',
  `use_money` decimal(6, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '允许使用金额',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 0未使用 1使用',
  `start_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '开始时间',
  `end_time` timestamp NOT NULL DEFAULT '2023-07-08 16:55:48' COMMENT '结束',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `coupons` VALUES (2, 1, '优惠券', 10.00, 10.00, 9999, '', '2023-07-01 00:00:00', '2023-08-31 00:00:00', '2023-07-03 17:11:47', '2023-07-03 17:11:47', NULL);
...
CREATE TABLE `currencies`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '名称' COMMENT '标题',
  `ename` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'zh-cn' COMMENT '多语种标识',
  `currency` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '￥' COMMENT '货币符号',
  `currency_ename` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RMB' COMMENT '支付标识',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '描述',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `distributions` VALUES (1, 1, 16, 1.00, 2.00, 3.00, '2023-07-03 17:11:15', '2023-07-03 17:11:15', NULL);
...
-- ----------------------------
-- Table structure for file_space_dirs
-- ----------------------------
DROP TABLE IF EXISTS `file_space_dirs`;
CREATE TABLE `file_space_dirs`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `belong_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属ID',
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'tmpdir' COMMENT '目录名称',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of file_space_dirs
-- ----------------------------

-- ----------------------------
-- Table structure for file_spaces
-- ----------------------------
DROP TABLE IF EXISTS `file_spaces`;
CREATE TABLE `file_spaces`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `belong_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属ID',
  `dir_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属文件夹',
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'filename' COMMENT '源文件名',
  `new_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'filename' COMMENT '新文件名',
  `md5` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'md5值',
  `url` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件地址',
  `ext_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ext_name' COMMENT '文件后缀',
  `disk_name` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public' COMMENT '存储位置',
  `info` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0*0' COMMENT '文件信息',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态',
  `is_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '上传类型 1分片',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of file_spaces
-- ----------------------------
INSERT INTO `file_spaces` VALUES (1, 1, 0, 'VCG41483485530', 'BNjTxPq6HgoGOBi9e3dAboFoVneLyy', '95abea27cd8eb685fb5c05b6720578d9', '/storage/avatar/2023-07-03/BNjTxPq6HgoGOBi9e3dAboFoVneLyymB06Pxteqq.jpg', 'jpg', 'public', '0*0', 1, 0, '2023-07-03 17:13:48', '2023-07-03 17:13:48', NULL);
INSERT INTO `file_spaces` VALUES (2, 1, 0, 'R-C (1)', 'KWwYhK53GG7i7jXYBxtHkugpdqMXaX', 'ebcf0a0114950256c3e378e7ead8fd1d', '/storage/goods/2023-07-03/KWwYhK53GG7i7jXYBxtHkugpdqMXaXDBPGcLReKw.jpg', 'jpg', 'public', '0*0', 1, 0, '2023-07-03 17:21:19', '2023-07-03 17:21:19', NULL);
INSERT INTO `file_spaces` VALUES (3, 1, 0, 'R-C', '60qG3SiKD5CorkeSbokqCglzwpi30K', 'ac913cbabde016fc5c377bb4e7bd145c', '/storage/goods/2023-07-03/60qG3SiKD5CorkeSbokqCglzwpi30Kk44IYRKU60.jpg', 'jpg', 'public', '0*0', 1, 0, '2023-07-03 17:21:32', '2023-07-03 17:21:32', NULL);
INSERT INTO `file_spaces` VALUES (4, 1, 0, 'b5b174f5c5d80101', 'YSpewoiWGug7yIoHjxi1HoILzr71yY', '4cb988f92212090cf55148153a04b601', '/storage/goods/2023-07-03/YSpewoiWGug7yIoHjxi1HoILzr71yY2j0PHFllev.jpg', 'jpg', 'public', '0*0', 1, 0, '2023-07-03 17:21:35', '2023-07-03 17:21:35', NULL);
...
-- ----------------------------
INSERT INTO `full_reductions` VALUES (1, 1, '满减', 12.00, 100.00, '2023-07-03 17:20:22', '2023-09-30 17:20:23', '2022-01-03 20:32:21', '2023-07-03 17:20:31', NULL);
...
CREATE TABLE `goods`  (
  ...
  `currency_id` int(10) UNSIGNED NOT NULL DEFAULT 1 COMMENT '货币类型',
  ...
  `freight_id` int(11) NOT NULL DEFAULT 0 COMMENT '运费模版 0默认',
...
INSERT INTO `goods` VALUES (15, 2, 29, 1, '一个人的世界史 解读20世纪', '郗士作序推荐', '', '/storage/goods/2023-07-03/YSpewoiWGug7yIoHjxi1HoILzr71yY2j0PHFllev.jpg', '/storage/goods/2023-07-03/YSpewoiWGug7yIoHjxi1HoILzr71yY2j0PHFllev.jpg', 1.00, 36.00, 1, 998, 1.00, 1, 0, 1, 1, '', 0, '<p><br></p>##qingwuit##[{\"type\":\"paragraph\",\"children\":[{\"text\":\"\"}]}]', '', 0, 0, '2021-02-21 14:32:14', '2023-07-03 17:21:56', NULL);
INSERT INTO `goods` VALUES (16, 2, 29, 1, '人生海海 解密人性的荒唐与高尚', '图书榜虚构类连续六周TOP1', '', '/storage/goods/2023-07-03/KWwYhK53GG7i7jXYBxtHkugpdqMXaXDBPGcLReKw.jpg', '/storage/goods/2023-07-03/KWwYhK53GG7i7jXYBxtHkugpdqMXaXDBPGcLReKw.jpg', 89.00, 289.00, 1, 1000, 1.00, 0, 0, 1, 1, '', 0, '<p><br></p>##qingwuit##[{\"type\":\"paragraph\",\"children\":[{\"text\":\"\"}]}]', '', 0, 0, '2021-02-21 14:33:02', '2023-07-03 17:21:23', NULL);
INSERT INTO `goods` VALUES (17, 2, 29, 1, '团购商品', '皮囊人生', '', '/storage/goods/2023-07-03/VcwXIaWC4NzSKYGFKjTJ0gGbCVG6Lsw0TAVL1yN7.jpg', '/storage/goods/2023-07-03/VcwXIaWC4NzSKYGFKjTJ0gGbCVG6Lsw0TAVL1yN7.jpg', 100.00, 200.00, 1, 997, 1.00, 1, 0, 1, 1, '', -1, '<p>阿斯顿发斯蒂芬</p>##qingwuit##[{\"type\":\"paragraph\",\"children\":[{\"text\":\"阿斯顿发斯蒂芬\"}]}]', '', 0, 0, '2021-02-21 14:34:05', '2023-07-03 20:30:30', NULL);
...
CREATE TABLE `integral_orders`  (
  ...
  `pay_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '支付时间',
  `delivery_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '发货时间',
...
-- ----------------------------
INSERT INTO `migrations` VALUES (75, '2016_06_01_000001_create_oauth_auth_codes_table', 1);
INSERT INTO `migrations` VALUES (76, '2016_06_01_000002_create_oauth_access_tokens_table', 1);
INSERT INTO `migrations` VALUES (77, '2016_06_01_000003_create_oauth_refresh_tokens_table', 1);
INSERT INTO `migrations` VALUES (78, '2016_06_01_000004_create_oauth_clients_table', 1);
INSERT INTO `migrations` VALUES (79, '2016_06_01_000005_create_oauth_personal_access_clients_table', 1);
INSERT INTO `migrations` VALUES (80, '2019_12_14_000001_create_personal_access_tokens_table', 1);
INSERT INTO `migrations` VALUES (81, '2021_09_20_074956_create_admins_table', 1);
INSERT INTO `migrations` VALUES (82, '2021_09_20_082115_create_admin_to_roles_table', 1);
INSERT INTO `migrations` VALUES (83, '2021_09_20_082233_create_admin_roles_table', 1);
INSERT INTO `migrations` VALUES (84, '2021_09_20_083042_create_admin_to_permissions_table', 1);
INSERT INTO `migrations` VALUES (85, '2021_09_20_083055_create_admin_permissions_table', 1);
INSERT INTO `migrations` VALUES (86, '2021_09_20_083107_create_admin_permission_groups_table', 1);
INSERT INTO `migrations` VALUES (87, '2021_09_20_084034_create_users_table', 1);
INSERT INTO `migrations` VALUES (88, '2021_09_20_084624_create_user_to_roles_table', 1);
INSERT INTO `migrations` VALUES (89, '2021_09_20_084638_create_user_roles_table', 1);
INSERT INTO `migrations` VALUES (90, '2021_09_20_084820_create_user_to_permissions_table', 1);
INSERT INTO `migrations` VALUES (91, '2021_09_20_084830_create_user_permissions_table', 1);
INSERT INTO `migrations` VALUES (92, '2021_09_20_084859_create_user_permission_groups_table', 1);
INSERT INTO `migrations` VALUES (93, '2021_09_20_162908_create_admin_to_menus_table', 1);
INSERT INTO `migrations` VALUES (94, '2021_09_20_162918_create_admin_menus_table', 1);
INSERT INTO `migrations` VALUES (95, '2021_09_20_162938_create_user_to_menus_table', 1);
INSERT INTO `migrations` VALUES (96, '2021_09_20_162946_create_user_menus_table', 1);
INSERT INTO `migrations` VALUES (97, '2021_11_25_211658_create_configs_table', 1);
INSERT INTO `migrations` VALUES (98, '2021_11_27_165759_create_sms_table', 1);
INSERT INTO `migrations` VALUES (99, '2021_11_27_165918_create_sms_logs_table', 1);
INSERT INTO `migrations` VALUES (100, '2021_11_30_161646_create_agreements_table', 1);
INSERT INTO `migrations` VALUES (101, '2021_11_30_210723_create_article_menus_table', 1);
INSERT INTO `migrations` VALUES (102, '2021_11_30_210731_create_articles_table', 1);
INSERT INTO `migrations` VALUES (103, '2021_11_30_210849_create_notices_table', 1);
INSERT INTO `migrations` VALUES (104, '2021_12_01_180556_create_adv_spaces_table', 1);
INSERT INTO `migrations` VALUES (105, '2021_12_01_180609_create_advs_table', 1);
INSERT INTO `migrations` VALUES (106, '2021_12_02_192750_create_order_pays_table', 1);
INSERT INTO `migrations` VALUES (107, '2021_12_04_170133_create_goods_classes_table', 1);
INSERT INTO `migrations` VALUES (108, '2021_12_04_170340_create_goods_brands_table', 1);
INSERT INTO `migrations` VALUES (109, '2021_12_04_170727_create_goods_table', 1);
INSERT INTO `migrations` VALUES (110, '2021_12_04_170929_create_goods_skus_table', 1);
INSERT INTO `migrations` VALUES (111, '2021_12_04_170942_create_goods_attrs_table', 1);
INSERT INTO `migrations` VALUES (112, '2021_12_04_171016_create_goods_specs_table', 1);
INSERT INTO `migrations` VALUES (113, '2021_12_04_172113_create_stores_table', 1);
INSERT INTO `migrations` VALUES (114, '2021_12_04_172237_create_store_classes_table', 1);
INSERT INTO `migrations` VALUES (115, '2021_12_06_175753_create_areas_table', 1);
INSERT INTO `migrations` VALUES (116, '2021_12_22_234135_create_order_comments_table', 1);
INSERT INTO `migrations` VALUES (117, '2021_12_23_173015_create_addresses_table', 1);
INSERT INTO `migrations` VALUES (118, '2021_12_24_155954_create_user_checks_table', 1);
INSERT INTO `migrations` VALUES (119, '2021_12_25_113940_create_cashes_table', 1);
INSERT INTO `migrations` VALUES (120, '2021_12_25_155127_create_favorites_table', 1);
INSERT INTO `migrations` VALUES (121, '2021_12_25_203720_create_money_logs_table', 1);
INSERT INTO `migrations` VALUES (122, '2021_12_26_171848_create_carts_table', 1);
INSERT INTO `migrations` VALUES (123, '2021_12_26_210445_create_orders_table', 1);
INSERT INTO `migrations` VALUES (124, '2021_12_26_210453_create_order_goods_table', 1);
INSERT INTO `migrations` VALUES (125, '2021_12_30_140506_create_coupons_table', 1);
INSERT INTO `migrations` VALUES (126, '2021_12_30_140556_create_coupon_logs_table', 1);
INSERT INTO `migrations` VALUES (127, '2021_12_30_141319_create_seckills_table', 1);
INSERT INTO `migrations` VALUES (128, '2021_12_30_141351_create_collectives_table', 1);
INSERT INTO `migrations` VALUES (129, '2021_12_30_141419_create_collective_logs_table', 1);
INSERT INTO `migrations` VALUES (130, '2021_12_30_141748_create_full_reductions_table', 1);
INSERT INTO `migrations` VALUES (131, '2021_12_30_150650_create_refunds_table', 1);
INSERT INTO `migrations` VALUES (132, '2021_12_30_181923_create_expresses_table', 1);
INSERT INTO `migrations` VALUES (133, '2022_01_01_200458_create_freights_table', 1);
INSERT INTO `migrations` VALUES (134, '2022_01_03_135219_create_distributions_table', 1);
INSERT INTO `migrations` VALUES (135, '2022_01_03_135228_create_distribution_logs_table', 1);
INSERT INTO `migrations` VALUES (136, '2022_01_04_160706_create_integral_goods_classes_table', 1);
INSERT INTO `migrations` VALUES (137, '2022_01_04_160722_create_integral_goods_table', 1);
INSERT INTO `migrations` VALUES (138, '2022_01_04_160743_create_integral_orders_table', 1);
INSERT INTO `migrations` VALUES (139, '2022_01_04_160753_create_integral_order_goods_table', 1);
INSERT INTO `migrations` VALUES (140, '2022_01_12_155950_create_oauths_table', 1);
INSERT INTO `migrations` VALUES (141, '2022_01_28_124455_create_order_settlements_table', 1);
INSERT INTO `migrations` VALUES (142, '2022_02_20_181251_create_chat_friends_table', 1);
INSERT INTO `migrations` VALUES (143, '2022_02_20_181334_create_chat_contents_table', 1);
INSERT INTO `migrations` VALUES (144, '2022_08_09_001657_create_captchas_table', 1);
INSERT INTO `migrations` VALUES (145, '2022_10_21_212237_create_app_versions_table', 1);
INSERT INTO `migrations` VALUES (146, '2023_05_13_235415_create_currencies_table', 1);
INSERT INTO `migrations` VALUES (147, '2023_05_17_203045_create_file_spaces_table', 1);
INSERT INTO `migrations` VALUES (148, '2023_05_17_205006_create_file_space_dirs_table', 1);
...
INSERT INTO `money_logs` VALUES (51, 1, '系统订单结算.', 'money', 34.90, 0, 1, 1, '', '2022-02-12 17:37:22', '2022-02-12 17:37:22', NULL);
...
INSERT INTO `money_logs` VALUES (59, 6, '订单支付', 'money', -21.00, 0, 0, 1, '', '2023-07-03 17:16:51', '2023-07-03 17:16:51', NULL);
INSERT INTO `money_logs` VALUES (60, 6, '订单支付', 'money', -3.99, 0, 0, 1, '', '2023-07-03 17:21:56', '2023-07-03 17:21:56', NULL);
...
-- ----------------------------
INSERT INTO `oauth_access_tokens` VALUES ('3a64438a3155c9f35b909d9172e0778c131772fb7552862a703529e7848668c3a64f2455a9801cfd', 11, '94730b8b-ecf3-4de6-b883-827bf0c1dccd', NULL, '[]', 0, '2023-07-03 20:28:49', '2023-07-03 20:28:49', '2023-07-10 20:28:49');
INSERT INTO `oauth_access_tokens` VALUES ('afbb347a737a88df3776ba1445bd7ef591ed4afd35e993e893110a53c76fab208af6f29e8f694aa6', 1, '94730bab-af28-4fad-9a04-c840694cafe4', NULL, '[]', 0, '2023-07-03 17:03:21', '2023-07-03 17:03:21', '2023-07-10 17:03:21');
INSERT INTO `oauth_access_tokens` VALUES ('f4ed52b767bc77c09952f0574fcd86dfacb0765d4aaaf03ddf5ac0b6dedf2e098ea9850678516b21', 6, '94730b8b-ecf3-4de6-b883-827bf0c1dccd', NULL, '[]', 0, '2023-07-03 17:08:42', '2023-07-03 17:08:42', '2023-07-10 17:08:42');
...
-- ----------------------------
INSERT INTO `oauth_refresh_tokens` VALUES ('0822366909fedf1322531d430daaa8e77885335b0835e38989472b6c3f84da3c7104eaa47ec7021f', '3a64438a3155c9f35b909d9172e0778c131772fb7552862a703529e7848668c3a64f2455a9801cfd', 0, '2023-07-17 20:28:49');
INSERT INTO `oauth_refresh_tokens` VALUES ('0e82d18d076639f2dbecc4e424c17cef2688e8444d977306aa4c7e60fe4f14fb05e65be2b1cdaadc', '878e19682f2fe929969e9c89349b10ce245ed66568d4f7448100165d69fd7c3dc47805d7261f45d9', 0, '2023-07-17 17:16:22');
INSERT INTO `oauth_refresh_tokens` VALUES ('102a2e8c6d9416650e8edc3cbcd15a7eef62e36567bad62af2d3274a8e33a66500863355962a1a14', 'afbb347a737a88df3776ba1445bd7ef591ed4afd35e993e893110a53c76fab208af6f29e8f694aa6', 0, '2023-07-17 17:03:21');
INSERT INTO `oauth_refresh_tokens` VALUES ('f589d7d544d26a8570c5ce65cb868698a2d4f0e8e22b685ca92d86520364120c3315be59f8cea524', 'f4ed52b767bc77c09952f0574fcd86dfacb0765d4aaaf03ddf5ac0b6dedf2e098ea9850678516b21', 0, '2023-07-17 17:08:42');
...
CREATE TABLE `order_comments`  (
  ...
  `reply_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:47' COMMENT '回复时间',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容',
...
INSERT INTO `order_goods` VALUES (31, 29, 0, 17, 6, 1, '团购商品', '/storage/goods/2023-07-03/VcwXIaWC4NzSKYGFKjTJ0gGbCVG6Lsw0TAVL1yN7_150.jpg', '-', 1, 18.00, 18.00, 1, 1.00, '2023-07-03 17:16:45', '2023-07-03 17:16:45', NULL);
INSERT INTO `order_goods` VALUES (32, 30, 0, 15, 6, 1, '一个人的世界史 解读20世纪', '/storage/goods/3/2021-02-21/86ho7T6wqOEOWR4dAo3i3qU39BZI3featTBH2AkL_150.jpg', '-', 1, 1.00, 1.00, 1, 1.00, '2023-07-03 17:19:15', '2023-07-03 17:19:15', NULL);
INSERT INTO `order_goods` VALUES (33, 31, 0, 15, 6, 1, '一个人的世界史 解读20世纪', '/storage/goods/2023-07-03/YSpewoiWGug7yIoHjxi1HoILzr71yY2j0PHFllev_150.jpg', '-', 1, 1.00, 1.00, 1, 1.00, '2023-07-03 17:21:50', '2023-07-03 17:21:50', NULL);
INSERT INTO `order_goods` VALUES (34, 32, 0, 17, 6, 1, '团购商品', '/storage/goods/2023-07-03/VcwXIaWC4NzSKYGFKjTJ0gGbCVG6Lsw0TAVL1yN7_150.jpg', '-', 1, 100.00, 100.00, 1, 1.00, '2023-07-03 17:24:20', '2023-07-03 17:24:20', NULL);
INSERT INTO `order_goods` VALUES (35, 33, 0, 17, 11, 1, '团购商品', '/storage/goods/2023-07-03/VcwXIaWC4NzSKYGFKjTJ0gGbCVG6Lsw0TAVL1yN7_150.jpg', '-', 1, 100.00, 100.00, 1, 1.00, '2023-07-03 20:30:30', '2023-07-03 20:30:30', NULL);
...
CREATE TABLE `order_pays`  (
  ...
  `pay_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '平台支付号',
...
INSERT INTO `order_pays` VALUES (21, 6, '团购商品', '29', '20230703171650635204', '-', 'balance', 'scan', 0, 21.00, 21.00, 1, 1, '2023-07-03 17:16:51', '2023-07-03 17:16:50', '2023-07-03 17:16:51', NULL);
INSERT INTO `order_pays` VALUES (22, 6, '一个人的世界史 解读20世纪', '31', '20230703172156662691', '-', 'balance', 'scan', 0, 3.99, 3.99, 1, 1, '2023-07-03 17:21:56', '2023-07-03 17:21:56', '2023-07-03 17:21:56', NULL);
...
CREATE TABLE `orders`  (
  ...
  `pay_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '支付时间',
  `delivery_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '发货时间',
  `receipt_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '确认收货时间',
  `comment_time` timestamp NOT NULL DEFAULT '2023-07-03 16:55:48' COMMENT '评论时间',
  `remark` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '备注',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
-- Records of seckills
-- ----------------------------
INSERT INTO `seckills` VALUES (1, 1, 15, 1.00, '2023-07-03 17:12:10', '2023-08-31 17:12:12', '2022-01-03 21:04:35', '2023-07-03 17:12:17', NULL);
...
-- ----------------------------
INSERT INTO `store_classes` VALUES (1, 1, '[[\"2\",\"8\",\"26\"],[\"2\",\"8\",\"27\"],[\"2\",\"8\",\"28\"]]', '', NULL, '2023-07-03 17:04:16', NULL);
...
-- Records of stores
-- ----------------------------
INSERT INTO `stores` VALUES (1, 6, '神秘商户', '/storage/store_logo/2023-07-03/zh9RvGtrq1uPgpEKOKzMaH93U7duHPn0keRc1GCo.png', '/storage/store_face/2021-12-19/vZug2Wh3P0cY4oB43Np0Hds1d7r5edo0tcx24Mfr.png', '18888888888', '该商户很懒，什么也没留下', '', '', 'asd', 1, 2, 3, '39.853106', '116.344857', '北京市 市辖区 东城区', 'asd', '/storage/business_license/2021-12-08/D8Wwqf2oLsUONi1lrDTBhXhCEMHO7Sny3FzOu69G.png', 'ds', 'sd', 'sd', 'sd', '/storage/id_card_t/2021-12-08/V08LXAyh21eGE6xLp78q9qx6o4GTmtMQhL9wADZX.png', '/storage/id_card_b/2021-12-08/v5GeXw1wUJt7Q5id5T7kZOPatlYn0JSRRHkLWYfK.png', 'ad', 'asd', 41.90, 5.00, 1, 4, '暂无原因', '<p>打撒cc</p>##qingwuit##[{\"type\":\"paragraph\",\"children\":[{\"text\":\"打撒cc\"}]}]', '2021-12-08 00:21:10', '2023-07-03 17:04:16', NULL);
...
INSERT INTO `user_to_menus` VALUES (8, 2, 1, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (9, 2, 37, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (10, 2, 38, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (11, 2, 4, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (12, 2, 13, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (13, 2, 14, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (14, 2, 15, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (15, 2, 16, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (16, 2, 30, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (17, 2, 19, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (18, 2, 20, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (19, 2, 31, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (20, 2, 32, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (21, 2, 21, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (22, 2, 22, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (23, 2, 23, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (24, 2, 18, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (25, 2, 24, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (26, 2, 33, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (27, 2, 34, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (28, 2, 25, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (29, 2, 35, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (30, 2, 36, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (31, 2, 26, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (32, 2, 27, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (33, 2, 28, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (34, 2, 17, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (35, 2, 29, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (36, 2, 5, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (37, 2, 6, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (38, 2, 7, NULL, NULL, NULL);
INSERT INTO `user_to_menus` VALUES (39, 2, 8, NULL, NULL, NULL);
...
INSERT INTO `user_to_roles` VALUES (2, 10, 2, NULL, NULL, NULL);
...
INSERT INTO `users` VALUES (6, 0, '18888888888', '$2y$10$WqUCMWwrebrPaWyU26NWHO8Y0Qd1/015dwe4WRcM/aN2Pte7R/YOm', '$2y$10$NaBTixd8YOw1B2oHv2xwtevE9bDKsV.tzbfbNqgDCZvV2W2sM6agC', '商家234', 1, '/storage/avatar/2021-12-24/9JpHKKkdPPfWnwgFa2dSh9rV9TvHokOVA9eW5z6x.jpg', '15073010917', '', 19.13, 11.00, 99.00, 0, 1, NULL, '0.0.0.0', '2023-07-03 17:16:22', '2023-07-03 17:08:43', '2021-12-07 19:32:40', '2023-07-03 20:08:41', NULL);
...
INSERT INTO `users` VALUES (9, 0, '商家2', '$2y$10$MAOMCUmQuSbYnxkLn8MFz.9PRMiciIA93ACSo.K8N6mnn5QI7mlyG', '$2y$10$sNnY.VIM.QT8LKtE8K2r6OmISCP399BSpmcg0wwh8NUqxojCPPa2a', '商家2', 1, '/storage/avatar/2023-07-03/hm6SlE7Ls7kKFisnZRfVffjndwfAPoAdd2F504LQ.jpg', '15888888888', '', 0.00, 0.00, 0.00, 0, 1, NULL, '0.0.0.0', NULL, NULL, '2023-07-03 17:09:47', '2023-07-03 17:09:47', NULL);
INSERT INTO `users` VALUES (10, 6, '商家001', '$2y$10$uewSXiy55XxgKJ52hPl/w.7kqNRgu6d7CpZU1vhhTy6vLhsM8Zzve', '', '商家001', 1, '/storage/avatar/2023-07-03/BNjTxPq6HgoGOBi9e3dAboFoVneLyymB06Pxteqq.jpg', '', '', 0.00, 0.00, 0.00, 0, 1, NULL, '0.0.0.0', NULL, NULL, '2023-07-03 17:13:49', '2023-07-03 17:13:49', NULL);
INSERT INTO `users` VALUES (11, 0, '15666666666', '$2y$10$XmnRwI.GAM/yFWt6H/M6WOo5tg5VrFEo6Mit0BpD7oBCxHxEpxLQ2', '$2y$10$eV/RoYKXxfTZ4wOTIwJjY.2/UR/5QH6DP9P5yD17suZLNHaBYB3b2', '15666666666', 1, '', '15666666666', '', 0.00, 0.00, 0.00, 0, 1, NULL, '0.0.0.0', '2023-07-03 20:28:49', '2023-07-03 20:28:49', '2023-07-03 20:28:48', '2023-07-03 20:28:49', NULL);
